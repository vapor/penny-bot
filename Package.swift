...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/apple/swift-nio", from: "2.57.0"),
        ...
        .package(url: "https://github.com/DiscordBM/DiscordLogger", from: "1.0.0-rc.2"),
        /// Not-released area:
        .package(url: "https://github.com/soto-project/soto", from: "7.0.0-alpha.1"),
        .package(url: "https://github.com/soto-project/soto-core", from: "7.0.0-alpha.2"),
        .package(url: "https://github.com/apple/swift-markdown", from: "0.3.0"),
        .package(url: "https://github.com/gwynne/swift-semver", from: "1.0.0-beta.1"),
        .package(
