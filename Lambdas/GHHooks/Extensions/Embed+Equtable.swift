...
extension Embed: Equatable {
    public static func == (lhs: Embed, rhs: Embed) -> Bool {
        lhs.title == rhs.title && lhs.type == rhs.type && lhs.description == rhs.description
            && lhs.url == rhs.url && lhs.timestamp?.date == rhs.timestamp?.date
            && lhs.color == rhs.color && lhs.footer == rhs.footer && lhs.image == rhs.image
            && lhs.thumbnail == rhs.thumbnail && lhs.video == rhs.video
...
extension Embed.Media: Equatable {
    public static func == (lhs: Embed.Media, rhs: Embed.Media) -> Bool {
        lhs.url.asString == rhs.url.asString && lhs.proxy_url ?== rhs.proxy_url && lhs.height
...
extension Embed.Footer: Equatable {
    public static func == (lhs: Embed.Footer, rhs: Embed.Footer) -> Bool {
        lhs.icon_url?.asString == rhs.icon_url?.asString && lhs.text == rhs.text
...
extension Embed.Author: Equatable {
    public static func == (lhs: Embed.Author, rhs: Embed.Author) -> Bool {
        lhs.url == rhs.url && lhs.icon_url?.asString == rhs.icon_url?.asString
            && lhs.name == rhs.name && lhs.proxy_icon_url ?== rhs.proxy_icon_url
    }
}
