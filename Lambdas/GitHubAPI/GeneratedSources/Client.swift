    ...
    public func apps_create_installation_access_token(
        ...
        try await client.send(
            ...
            deserializer: { response in
                ...
                case 201:
                    let headers: Operations.apps_create_installation_access_token.Output.Created.Headers =
                        .init()
    ...
    public func repos_list_pull_requests_associated_with_commit(
        ...
        try await client.send(
            ...
            deserializer: { response in
                switch response.statusCode {
                case 200:
                    let headers: Operations.repos_list_pull_requests_associated_with_commit.Output.Ok.Headers =
                        .init(
