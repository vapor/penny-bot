...
package typealias _Foundation_URL = FoundationEssentials.URL
#else
package import struct Foundation.URL
package typealias _Foundation_URL = Foundation.URL
#endif
...
package struct Client: APIProtocol {
    ...
    package func projectsListFieldsForOrg(
        ...
        try await client.send(
            ...
            deserializer: { response, responseBody in
                switch response.status.code {
                case 200:
                    let headers: Operations.ProjectsListFieldsForOrg.Output.Ok.Headers = .init(
    ...
    package func projectsListItemsForOrg(
        ...
        try await client.send(
            ...
            deserializer: { response, responseBody in
                switch response.status.code {
                case 200:
                    let headers: Operations.ProjectsListItemsForOrg.Output.Ok.Headers = .init(
                        link: try converter.getOptionalHeaderFieldAsURI(
                            in: response.headerFields,
                            name: "Link",
                            as: Components.Headers.Link.self
    ...
    package func reposListCommits(
        _ input: Operations.ReposListCommits.Input
        ...
        try await client.send(
            ...
            deserializer: { response, responseBody in
                switch response.status.code {
                case 200:
                    let headers: Operations.ReposListCommits.Output.Ok.Headers = .init(
                        link: try converter.getOptionalHeaderFieldAsURI(
                            in: response.headerFields,
                            name: "Link",
                            as: Components.Headers.Link.self
    ...
    package func reposListPullRequestsAssociatedWithCommit(
        ...
        try await client.send(
            ...
            deserializer: { response, responseBody in
                switch response.status.code {
                case 200:
                    let headers: Operations.ReposListPullRequestsAssociatedWithCommit.Output.Ok.Headers = .init(
                        link: try converter.getOptionalHeaderFieldAsURI(
                            in: response.headerFields,
                            name: "Link",
                            as: Components.Headers.Link.self
    ...
    package func reposListContributors(
        ...
        try await client.send(
            ...
            deserializer: { response, responseBody in
                switch response.status.code {
                case 200:
                    let headers: Operations.ReposListContributors.Output.Ok.Headers = .init(
                        link: try converter.getOptionalHeaderFieldAsURI(
                            in: response.headerFields,
                            name: "Link",
                            as: Components.Headers.Link.self
    ...
    package func issuesCreate(_ input: Operations.IssuesCreate.Input) async throws -> Operations.IssuesCreate.Output {
        try await client.send(
            ...
            deserializer: { response, responseBody in
                switch response.status.code {
                case 201:
                    let headers: Operations.IssuesCreate.Output.Created.Headers = .init(
    ...
    package func issuesListComments(
        ...
        try await client.send(
            ...
            deserializer: { response, responseBody in
                switch response.status.code {
                case 200:
                    let headers: Operations.IssuesListComments.Output.Ok.Headers = .init(
                        link: try converter.getOptionalHeaderFieldAsURI(
                            in: response.headerFields,
                            name: "Link",
                            as: Components.Headers.Link.self
    ...
    package func issuesCreateComment(
        ...
        try await client.send(
            ...
            deserializer: { response, responseBody in
                switch response.status.code {
                case 201:
                    let headers: Operations.IssuesCreateComment.Output.Created.Headers = .init(
                        location: try converter.getOptionalHeaderFieldAsURI(
                            in: response.headerFields,
                            name: "Location",
                            as: Swift.String.self
    ...
    package func pullsListFiles(
        _ input: Operations.PullsListFiles.Input
        ...
        try await client.send(
            ...
            deserializer: { response, responseBody in
                switch response.status.code {
                case 200:
                    let headers: Operations.PullsListFiles.Output.Ok.Headers = .init(
                        link: try converter.getOptionalHeaderFieldAsURI(
                            in: response.headerFields,
                            name: "Link",
                            as: Components.Headers.Link.self
    ...
    package func pullsListReviews(
        _ input: Operations.PullsListReviews.Input
        ...
        try await client.send(
            ...
            deserializer: { response, responseBody in
                switch response.status.code {
                case 200:
                    let headers: Operations.PullsListReviews.Output.Ok.Headers = .init(
                        link: try converter.getOptionalHeaderFieldAsURI(
                            in: response.headerFields,
                            name: "Link",
                            as: Components.Headers.Link.self
    ...
    package func reposListReleases(
        ...
        try await client.send(
            ...
            deserializer: { response, responseBody in
                switch response.status.code {
                case 200:
                    let headers: Operations.ReposListReleases.Output.Ok.Headers = .init(
                        link: try converter.getOptionalHeaderFieldAsURI(
                            in: response.headerFields,
                            name: "Link",
                            as: Components.Headers.Link.self
    ...
    package func reposCreateRelease(
        ...
        try await client.send(
            ...
            deserializer: { response, responseBody in
                switch response.status.code {
                case 201:
                    let headers: Operations.ReposCreateRelease.Output.Created.Headers = .init(
                        location: try converter.getOptionalHeaderFieldAsURI(
                            in: response.headerFields,
                            name: "Location",
                            as: Swift.String.self
    ...
    package func reposListTags(_ input: Operations.ReposListTags.Input) async throws -> Operations.ReposListTags.Output
    {
        try await client.send(
            ...
            deserializer: { response, responseBody in
                switch response.status.code {
                case 200:
                    let headers: Operations.ReposListTags.Output.Ok.Headers = .init(
                        link: try converter.getOptionalHeaderFieldAsURI(
                            in: response.headerFields,
                            name: "Link",
                            as: Components.Headers.Link.self
