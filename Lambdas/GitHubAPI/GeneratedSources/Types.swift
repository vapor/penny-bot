...
package protocol APIProtocol: Sendable {
    ...
    func projectsDeleteCard(
        _ input: Operations.ProjectsDeleteCard.Input
    ...
    func projectsListCards(
        _ input: Operations.ProjectsListCards.Input
...
extension APIProtocol {
    ...
    package func projectsDeleteCard(
        ...
        try await projectsDeleteCard(
            Operations.ProjectsDeleteCard.Input(
                path: path,
                headers: headers
            )
        )
    ...
    package func projectsMoveCard(
        ...
        try await projectsMoveCard(
            Operations.ProjectsMoveCard.Input(
                path: path,
                headers: headers,
                body: body
            )
    ...
    package func projectsListCards(
        ...
        try await projectsListCards(
            Operations.ProjectsListCards.Input(
                path: path,
                query: query,
                headers: headers
            )
...
package enum Operations {
    ...
    package enum ProjectsDeleteCard {
        ...
        package struct Input: Sendable, Hashable {
            ...
            package struct Headers: Sendable, Hashable {
                package var accept:
                    [OpenAPIRuntime.AcceptHeaderContentType<Operations.ProjectsDeleteCard.AcceptableContentType>]
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
                ///   - accept:
                package init(
                    accept: [OpenAPIRuntime.AcceptHeaderContentType<
                        Operations.ProjectsDeleteCard.AcceptableContentType
                    >] = .defaultValues()
                ) {
                    self.accept = accept
                }
    ...
    package enum ProjectsMoveCard {
        ...
        package struct Input: Sendable, Hashable {
            ...
            package struct Headers: Sendable, Hashable {
                package var accept:
                    [OpenAPIRuntime.AcceptHeaderContentType<Operations.ProjectsMoveCard.AcceptableContentType>]
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
                ///   - accept:
                package init(
                    accept: [OpenAPIRuntime.AcceptHeaderContentType<
                        Operations.ProjectsMoveCard.AcceptableContentType
                    >] = .defaultValues()
                ) {
                    self.accept = accept
                }
            ...
            package struct Forbidden: Sendable, Hashable {
                ...
                @frozen package enum Body: Sendable, Hashable {
                    ...
                    package struct JsonPayload: Codable, Hashable, Sendable {
                        ...
                        package typealias ErrorsPayload = [Operations.ProjectsMoveCard.Output.Forbidden.Body.JsonPayload
            ...
            package struct ServiceUnavailable: Sendable, Hashable {
                ...
                @frozen package enum Body: Sendable, Hashable {
                    ...
                    package struct JsonPayload: Codable, Hashable, Sendable {
                        ...
                        package typealias ErrorsPayload = [Operations.ProjectsMoveCard.Output.ServiceUnavailable.Body
                            .JsonPayload.ErrorsPayloadPayload]
                        /// - Remark: Generated from `#/paths/projects/columns/cards/{card_id}/moves/POST/responses/503/content/json/errors`.
                        package var errors:
                            Operations.ProjectsMoveCard.Output.ServiceUnavailable.Body.JsonPayload.ErrorsPayload?
                        /// Creates a new `JsonPayload`.
                        ///
                        /// - Parameters:
                        ///   - code:
                        ...
                        package init(
                            ...
                            message: Swift.String? = nil,
                            documentationUrl: Swift.String? = nil,
                            errors: Operations.ProjectsMoveCard.Output.ServiceUnavailable.Body.JsonPayload
                                .ErrorsPayload? = nil
                        ) {
                            self.code = code
                            self.message = message
    ...
    package enum ProjectsListCards {
        ...
        package struct Input: Sendable, Hashable {
            ...
            package struct Headers: Sendable, Hashable {
                package var accept:
                    [OpenAPIRuntime.AcceptHeaderContentType<Operations.ProjectsListCards.AcceptableContentType>]
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
                ///   - accept:
                package init(
                    accept: [OpenAPIRuntime.AcceptHeaderContentType<
                        Operations.ProjectsListCards.AcceptableContentType
                    >] = .defaultValues()
                ) {
                    self.accept = accept
                }
    ...
    package enum ProjectsCreateCard {
        ...
        package struct Input: Sendable, Hashable {
            ...
            package struct Headers: Sendable, Hashable {
                package var accept:
                    [OpenAPIRuntime.AcceptHeaderContentType<Operations.ProjectsCreateCard.AcceptableContentType>]
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
                ///   - accept:
                package init(
                    accept: [OpenAPIRuntime.AcceptHeaderContentType<
                        Operations.ProjectsCreateCard.AcceptableContentType
                    >] = .defaultValues()
                ) {
                    self.accept = accept
                }
            ...
            package struct ServiceUnavailable: Sendable, Hashable {
                ...
                @frozen package enum Body: Sendable, Hashable {
                    ...
                    package struct JsonPayload: Codable, Hashable, Sendable {
                        ...
                        package typealias ErrorsPayload = [Operations.ProjectsCreateCard.Output.ServiceUnavailable.Body
                            .JsonPayload.ErrorsPayloadPayload]
                        /// - Remark: Generated from `#/paths/projects/columns/{column_id}/cards/POST/responses/503/content/json/errors`.
                        package var errors:
                            Operations.ProjectsCreateCard.Output.ServiceUnavailable.Body.JsonPayload.ErrorsPayload?
                        /// Creates a new `JsonPayload`.
                        ///
                        /// - Parameters:
                        ///   - code:
                        ...
                        package init(
                            ...
                            message: Swift.String? = nil,
                            documentationUrl: Swift.String? = nil,
                            errors: Operations.ProjectsCreateCard.Output.ServiceUnavailable.Body.JsonPayload
                                .ErrorsPayload? = nil
                        ) {
                            self.code = code
                            self.message = message
