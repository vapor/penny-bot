...
package typealias IssueComment = Components.Schemas.IssueComment
package typealias ReactionContent = Operations.ReactionsCreateForIssueComment.Input.Body.JsonPayload.ContentPayload
