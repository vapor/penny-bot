...
public typealias PullRequestReview = Components.Schemas.pull_request_review
public typealias DiffEntry = Components.Schemas.diff_entry
public typealias Commit = Components.Schemas.commit
public typealias SimpleCommit = Components.Schemas.simple_commit
